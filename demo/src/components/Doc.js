    ...
    <div>
      ...
      <div className='grid grid-cols-9 font-dm '>
        ...
        <div className='col-span-6' id='main section'>
           ...
           <section class='m-10'>
           <h2 class="mb-2.5  mt-2.5 text-xl font-bold leading-tight text-neutral-800 dark:text-neutral-50">
                  Intoduction</h2>
           ...
           <h2 class="mb-2.5 mt-3.5 text-xl font-bold leading-tight text-neutral-800 dark:text-neutral-50">
          ...
          <h2 class="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-neutral-800 dark:text-neutral-50">
