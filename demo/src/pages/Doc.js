    ...
    <div>
      ...
      <div className='grid grid-cols-9 font-dm '>
        ...
        <div className='col-span-6' id='main section'>
           ...
           <section className='m-10 text-black'>
           <h2 className="mb-2.5  mt-2.5 text-xl font-bold leading-tight text-black">
                  Intoduction</h2>
           ...
           <h2 className="mb-2.5 mt-3.5 text-xl font-bold leading-tight text-black">
           ...
           <section id='usage'>
            <div className="flex justify-center mt-6">
              <div className="block w-60 rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-700">
                <h5 className="mb-2 text-xl font-bold leading-tight text-black">
                 Requirements              
                 </h5>
                <p className="mb-4 w-36 text-base text-neutral-600 dark:text-neutral-200">
                  <ul>
                    <li>import flask            </li>
                    <li>import numpy</li>
          ...
          <h2 className="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-black">
          Filtering Criteria</h2>
           <p className='ml-10'>It does not detect the cartoon images or distorted images.The photos were filtered out on the of them being human or non human. Then it filters out whether it is a male face or a female face. </p>
           <h2 className="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-black">
           Gender Detection</h2>
           <p className='ml-10'>The dataset with the male:female ratio of 50:50 was used to train the model</p>
           <h2 className="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-black">
           Accuracy</h2>
           <p className='ml-10'>The dataset currently is trained with  1400 images ( 700 each ) with more than the accuracy of 96% of detecting fake photo. </p>     
           <section id='faq'>
            <div className="flex justify-center mt-2">
              <div className="block max-w-xl rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-700">
           ...
           <h2 className="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-black">
           Upgrades</h2>
           <p className='ml-10'>The popular models do not diffrentaite a cartoon or a distorted image fom a real human photo. It also does not detect the gender and inputs a male photo where a female photo was to be inserted. </p>
           <h2 className="mb-6 ml-10 mt-3.5 text-xl font-bold leading-tight text-black">
           Future scope</h2>
           <p className='ml-10'>The model could further be improved to add the links of people's profile in social platforms like Instagram,Facebook Twitter,etc.
